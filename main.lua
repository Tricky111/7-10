...
local sheetIdleNinja = graphics.newImageSheet( "ninjaGirlRun.png",  sheetOptionsIdle )
...
local sheetWalkingNinja = graphics.newImageSheet( "ninjaGirlAttack.png", sheetOptionsWalk )
